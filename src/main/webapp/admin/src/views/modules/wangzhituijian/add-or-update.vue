<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="网址名称" prop="wangzhimingcheng">
          <el-input v-model="ruleForm.wangzhimingcheng" 
              placeholder="网址名称" clearable  :readonly="ro.wangzhimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="网址名称" prop="wangzhimingcheng">
              <el-input v-model="ruleForm.wangzhimingcheng" 
                placeholder="网址名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="网址来源" prop="wangzhilaiyuan">
          <el-input v-model="ruleForm.wangzhilaiyuan" 
              placeholder="网址来源" clearable  :readonly="ro.wangzhilaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="网址来源" prop="wangzhilaiyuan">
              <el-input v-model="ruleForm.wangzhilaiyuan" 
                placeholder="网址来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="视频分享" prop="shipinfenxiang">
          <file-upload
          tip="点击上传视频分享"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shipinfenxiang?ruleForm.shipinfenxiang:''"
          @change="shipinfenxiangUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.shipinfenxiang" label="视频分享" prop="shipinfenxiang">
            <el-button type="text" size="small" @click="download(ruleForm.shipinfenxiang)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantupian.split(',')" :src="item" width="100" height="100">
                                      ...
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="网址介绍" prop="wangzhijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="网址介绍"
                  v-model="ruleForm.wangzhijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wangzhijieshao" label="网址介绍" prop="wangzhijieshao">
                    <span>{{ruleForm.wangzhijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="操作简介" prop="caozuojianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.caozuojianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.caozuojianjie" label="操作简介" prop="caozuojianjie">
                    <span v-html="ruleForm.caozuojianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="网址详情" prop="wangzhixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wangzhixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wangzhixiangqing" label="网址详情" prop="wangzhixiangqing">
                    <span v-html="ruleForm.wangzhixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	wangzhimingcheng : false,
	wangzhijieshao : false,
	xingming : false,
	zhanghao : false,
	zhaopian : false,
	wangzhilaiyuan : false,
	shipinfenxiang : false,
	caozuojianjie : false,
	fabushijian : false,
	fengmiantupian : false,
	wangzhixiangqing : false,
	thumbsupnum : false,
	crazilynum : false,
      },
            ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='wangzhimingcheng'){
            this.ruleForm.wangzhimingcheng = obj[o];
	    this.ro.wangzhimingcheng = true;
            continue;
          }
	            	            if(o=='wangzhijieshao'){
            this.ruleForm.wangzhijieshao = obj[o];
	    this.ro.wangzhijieshao = true;
            continue;
          }
	            	            if(o=='xingming'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='wangzhilaiyuan'){
            this.ruleForm.wangzhilaiyuan = obj[o];
	    this.ro.wangzhilaiyuan = true;
            continue;
          }
	            	            if(o=='shipinfenxiang'){
            this.ruleForm.shipinfenxiang = obj[o];
	    this.ro.shipinfenxiang = true;
            continue;
          }
	            	            if(o=='caozuojianjie'){
            this.ruleForm.caozuojianjie = obj[o];
	    this.ro.caozuojianjie = true;
            continue;
          }
	            	            if(o=='fabushijian'){
	    ...
	    this.ro.fengmiantupian = true;
            continue;
	            	            ...
	            	            if(o=='wangzhixiangqing'){
            this.ruleForm.wangzhixiangqing = obj[o];
	    this.ro.wangzhixiangqing = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
	...
	this.ruleForm.caozuojianjie = this.ruleForm.caozuojianjie.replace(reg,'../../../ssm25hxr/upload');
	this.ruleForm.wangzhixiangqing = this.ruleForm.wangzhixiangqing.replace(reg,'../../../ssm25hxr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wangzhituijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wangzhituijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                            ...
                                            shipinfenxiangUploadChange(fileUrls) {
                this.ruleForm.shipinfenxiang = fileUrls;
				this.addEditUploadStyleChange()
            },
