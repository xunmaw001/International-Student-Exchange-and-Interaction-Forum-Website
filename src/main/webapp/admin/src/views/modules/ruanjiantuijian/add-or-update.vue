        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="软件来源" prop="ruanjianlaiyuan">
          <el-input v-model="ruleForm.ruanjianlaiyuan" 
              placeholder="软件来源" clearable  :readonly="ro.ruanjianlaiyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="软件来源" prop="ruanjianlaiyuan">
              <el-input v-model="ruleForm.ruanjianlaiyuan" 
                placeholder="软件来源" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantupian.split(',')" :src="item" width="100" height="100">
                                      ...
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="软件介绍" prop="ruanjianjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="软件介绍"
                  v-model="ruleForm.ruanjianjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ruanjianjieshao" label="软件介绍" prop="ruanjianjieshao">
                    <span>{{ruleForm.ruanjianjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="软件详情" prop="ruanjianxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ruanjianxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ruanjianxiangqing" label="软件详情" prop="ruanjianxiangqing">
                    <span v-html="ruleForm.ruanjianxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	ruanjianjieshao : false,
	zhanghao : false,
	xingming : false,
	zhaopian : false,
	ruanjianlaiyuan : false,
	shipinfenxiang : false,
	fabushijian : false,
	ruanjianxiangqing : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ruanjianmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='ruanjianjieshao'){
            this.ruleForm.ruanjianjieshao = obj[o];
	    this.ro.ruanjianjieshao = true;
            continue;
          }
	            	            if(o=='zhanghao'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='ruanjianlaiyuan'){
            this.ruleForm.ruanjianlaiyuan = obj[o];
	    this.ro.ruanjianlaiyuan = true;
            continue;
          }
	            	            if(o=='shipinfenxiang'){
	    ...
	    this.ro.fabushijian = true;
            continue;
	            	            ...
	            	            if(o=='ruanjianxiangqing'){
            this.ruleForm.ruanjianxiangqing = obj[o];
	    this.ro.ruanjianxiangqing = true;
            continue;
          }
	            	            if(o=='fengmiantupian'){
	...
	this.ruleForm.ruanjianxiangqing = this.ruleForm.ruanjianxiangqing.replace(reg,'../../../ssm25hxr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ruanjiantuijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ruanjiantuijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
