              ...
              <div v-else>
                <el-form-item v-if="ruleForm.neirong" label="内容" prop="neirong">
                    <span>{{ruleForm.neirong}}</span>
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人想法" prop="gerenxiangfa">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gerenxiangfa" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerenxiangfa" label="个人想法" prop="gerenxiangfa">
                    <span v-html="ruleForm.gerenxiangfa"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong = true;
            continue;
	            	            ...
	            	            if(o=='gerenxiangfa'){
            this.ruleForm.gerenxiangfa = obj[o];
	    this.ro.gerenxiangfa = true;
            continue;
          }
	            	            if(o=='zhaopian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.$http({
              url: `option/biaoqianfenlei/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.gerenxiangfa = this.ruleForm.gerenxiangfa.replace(reg,'../../../ssm25hxr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
