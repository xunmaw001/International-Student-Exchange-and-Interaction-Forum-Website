        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantupian" label="封面图片" prop="fengmiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantupian.split(',')" :src="item" width="100" height="100">
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="方法内容" prop="fangfaneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="方法内容"
                  v-model="ruleForm.fangfaneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangfaneirong" label="方法内容" prop="fangfaneirong">
                    <span>{{ruleForm.fangfaneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="其他建议" prop="qitajianyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="其他建议"
                  v-model="ruleForm.qitajianyi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qitajianyi" label="其他建议" prop="qitajianyi">
                    <span>{{ruleForm.qitajianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="方法详情" prop="fangfaxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fangfaxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangfaxiangqing" label="方法详情" prop="fangfaxiangqing">
                    <span v-html="ruleForm.fangfaxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='fangfaneirong'){
            this.ruleForm.fangfaneirong = obj[o];
	    this.ro.fangfaneirong = true;
            continue;
          }
	            	            if(o=='fangfaxiangqing'){
            this.ruleForm.fangfaxiangqing = obj[o];
	    this.ro.fangfaxiangqing = true;
            continue;
          }
	            	            if(o=='qitajianyi'){
            this.ruleForm.qitajianyi = obj[o];
	    this.ro.qitajianyi = true;
            continue;
          }
	            	            if(o=='fabushijian'){
	...
	this.ruleForm.fangfaxiangqing = this.ruleForm.fangfaxiangqing.replace(reg,'../../../ssm25hxr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jihuafenxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jihuafenxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
